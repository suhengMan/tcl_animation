#include "lvgl.h"
#include "cl_ui.h"
#include "pg_img_play.h"
#include "vw_img_play.h"

static img_play_pg_t pg;
...
{
    // img_play_model_init(); // 如有模型初始化可放开
    pg.view = img_play_view_create(self->root);
}
