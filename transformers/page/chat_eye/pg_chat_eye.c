#include "lvgl.h"
#include "cl_ui.h"
#include "pg_chat_eye.h"
#include "vw_chat_eye.h"

static chat_eye_pg_t pg;
...
{
    // chat_eye_model_init(); // 如有模型初始化可放开
    pg.view = chat_eye_view_create(self->root);
}
