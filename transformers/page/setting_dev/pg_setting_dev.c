#include "lvgl.h"
#include "cl_ui.h"
#include "pg_setting_dev.h"
#include "vw_setting_dev.h"

static setting_dev_pg_t pg;
...
{
    // setting_dev_model_init(); // 如有模型初始化可放开
    pg.view = setting_dev_view_create(self->root);
}
